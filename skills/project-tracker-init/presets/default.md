...
| `conventions.md` | `templates/conventions.md.tmpl` | `AGENTS.md`, `.agents/rules/`, `.claude/CLAUDE.md`, `.editorconfig`, linter/formatter configs | Extract conventions from project configs |
